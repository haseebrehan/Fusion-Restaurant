        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="Navbar">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="./contactus.html"><span class="fa fa-list fa-lg"></span> Menu</a></li>
        ...
        <div class="modal-dialog modal-lg" role="content">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="">
                            <div class="row mt-0 mb-3 ml-3">
                                <div class="col-12 col-sm-3 ">Number of Guests</div>
                                    <div class="form-check form-check-inline ml-5 ml-sm-3">
                            ...
                            <div class="row ml-3 mb-4">
                                <div class="col-12 col-sm-3 ">Section</div>
                            ...
                            <div class="row ml-3">
                            <div class="col-12 col-sm-3">Date and Time</div>
    ...
    <header class="jumbotron">
        <div class="container">
            <div class="row row-header">
                ...
                <div class="col-12 col-sm align-self-center">
                    <a role="button" class="btn btn-block nav-link btn-warning" data-toggle="modal" data-target="#reserveform" href="">
                        <h3 class="text-white">Reserve Table</h3></a>
                </div>
                            ...
                            <div class="carousel-item">
                                ...
                                <div class="carousel-caption d-none d-md-block">
                                    ...
                                    <p class="d-none d-sm-block">Featuring mouthwatering combinations with a choice of
                                         five different salads, six enticing appetizers, six main entrees and five 
        ...
        <div class="row row-content  align-items-center">
            ...
            <div class="col col-sm col-md">
                <div class="media">
                    ...
                    <img class="d-flex ml-3 img-thumbnail align-self-center order-sm-last" src="img/buffet.png" alt="buffet">
                </div>
            </div>
        </div>
